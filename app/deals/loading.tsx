/**
 * /deals loading state — title shell + 3-card product grid skeleton.
 * Mirrors the curated-section layout so the swap feels seamless. No prose
 * copy. Animations respect prefers-reduced-motion via the global rule in
 * globals.css.
 */
