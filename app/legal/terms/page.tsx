...
export default function TermsPage() {
  return (
    ...
    >
      ...
      <p>
        Delivery is offered only to ZIP codes we are licensed and able to serve across Manhattan plus parts of Brooklyn (Williamsburg, Greenpoint) and Queens (Long Island City), under the cannabis program of the {business.licensingAuthority}. Final delivery eligibility is confirmed during checkout. We do not ship cannabis products outside our licensed service area.
      </p>
