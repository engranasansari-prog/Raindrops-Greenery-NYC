...
export default function NewsletterForm({ source = 'website-footer' }: { source?: string }) {
  ...
  return (
    <form onSubmit={submit} className="grid w-full max-w-md gap-3" aria-label="Email signup">
      <div className="flex items-stretch overflow-hidden rounded-full border border-[color:var(--rd-paper)]/14 bg-[color:var(--rd-ink-soft)]/55 transition focus-within:border-[color:var(--rd-glow)] focus-within:shadow-[0_0_0_4px_rgba(198,160,100,0.18)]">
