                ...
                >
                  <label className="grid gap-1.5">
                    ...
                    <input
                      ...
                      className="h-12 rounded-full border border-[color:var(--rd-paper)]/14 bg-[color:var(--rd-ink-soft)]/55 px-4 text-sm text-[color:var(--rd-text)] outline-none transition placeholder:text-[color:var(--rd-text-mute)] focus:border-[color:var(--rd-glow)] focus:shadow-[0_0_0_4px_rgba(198,160,100,0.18)] disabled:opacity-60"
                    />
                  </label>
                  <label className="grid gap-1.5">
